                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="py-2 mx-auto items-center flex flex-wrap">
                                    <ul className="flex pl-0 rounded list-none flex-wrap lg:w-12/12">
                                        <li>
                                            <Link href="/publikasi">
                                                <a className="first:ml-0 mr-1 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-slate-500 bg-slate-700 text-white">
                                        ...
                                        <li>
                                            <Link href="/publikasi#1">
                                                <a className="1 first:ml-0 mr-1 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-slate-500 bg-white text-slate-500">
                                                    1
                                                </a></Link>
                                        </li>
                                        <li>

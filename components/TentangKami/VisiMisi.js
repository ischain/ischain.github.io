          ...
          <div className="container mx-auto px-4 lg:pt-24 lg:pb-42 sm:pb-48 sm:pt-36 xs:pb-32 xs:pt-32">
            ...
            <div className="flex flex-wrap mt-12 justify-center">
              <div className="w-full lg:w-4/12 px-6 text-center">
                ...
                <h6 className="text-xl mt-5 font-bold text-slate-700">
                  Edukasi
                </h6>
                <p className="mt-2 mb-4 font-medium text-slate-500">
              ...
              <div className="w-full lg:w-4/12 px-6 text-center">
                <div className="text-white p-3 w-12 h-12 shadow-lg rounded-full bg-sky-400 inline-flex items-center justify-center">
                  <i className="fas fa-poll text-xl"></i>
                </div>
                <h5 className="text-xl mt-5 font-bold text-slate-700">
                  Kolaborasi
                </h5>
                <p className="mt-2 mb-4 font-medium text-slate-500">

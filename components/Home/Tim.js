...
export default function Tim() {
  return (
    ...
    <section className="pb-16 bg-slate-100 relative pt-32">
        <div
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10 bg-slate-700">

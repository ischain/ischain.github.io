            ...
            {/* End Input Artikel Card */}
              ...
              <div className="justify-center py-2 mx-auto items-center flex flex-wrap mt-2">
                <ul className="flex pl-0 rounded list-none flex-wrap lg:w-12/12">
                    <li>
                        <a href="/Artikel" className="first:ml-0 mr-1 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-slate-500 bg-slate-700 text-white">
                    ...
                    <li>
                        <a href="/Artikel#1" className="1 first:ml-0 mr-1 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-slate-500 bg-white text-slate-500">
                          1
                        </a>
                    </li>
                    <li>

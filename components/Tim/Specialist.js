        ...
        <div className="flex-auto p-4">
          <div className="flex flex-wrap">
            ...
            <div className="relative w-auto pl-4 flex-initial relative xs:relative sm:relative">
              <div
                className=
                  "text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-lg rounded-full bg-green-500"
              >
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Blockchain Tech Specialist</p>
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of DeFi Specialist</p>
              <span className="text-black mr-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Business & Investment Specialist</p>
              <span className="text-black mr-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of NFT & Metaverse</p>
              <span className="text-black mr-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Engineering</p>
              <span className="text-black mr-2">
                Andika D. Riyandi, S.T., S.H.
              </span>
              <div className="mt-0 lg:mb-0 mb-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Fundamental Analyst</p>
              <span className="text-black mr-2">
                Fikri Faris, Ph.D.
              </span>
              <div className="mt-0 lg:mb-0 mb-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Community & Social Media</p>
              <span className="text-black mr-2">
          ...
          <div className="text-md text-black mt-4">
            <p className="font-semibold text-green-500">Head of Strategic Partnership</p>
              <span className="text-black mr-2">

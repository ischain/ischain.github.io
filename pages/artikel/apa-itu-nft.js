          ...
          <div className="px-6">
            <div className="flex flex-wrap justify-center">
              ...
              <div className="w-full w-12/12 px-4 lg:order-3 text-justify self-center">
                  ...
                  <h2>Apa yang dimaksud dengan NFT?</h2>
                  <p className="mb-4 text-lg leading-relaxed text-slate-800">
                  ...
                  <p className="mb-4 text-lg leading-relaxed text-slate-800">
                     Contohnya, anda bisa upload NFT anda di <a href="https://opensea.io">https://opensea.io</a>. Syarat untuk menjual NFT, anda harus punya beberapa koin ETH (Ethereum).
                  </p>
                  <h2>Apakah NFT harus berupa karya seni?</h2>
                  <p className="mb-4 text-lg leading-relaxed text-slate-800">
                  ...
                  <h2>Apa bedanya NFT dengan mata uang kripto?</h2>
                  <p className="mb-4 text-lg leading-relaxed text-slate-800">
                  ...
                  <h2>Apa hukum berjualan NFT dalam Islam?</h2>
                  <p className="mb-4 text-lg leading-relaxed text-slate-800">

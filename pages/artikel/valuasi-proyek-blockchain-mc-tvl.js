            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full w-12/12 px-4 lg:order-3 text-justify self-center">
                  ...
                  />
                  <Paragraf Kalimat="Stepnya bagaimana? Misal kita mau cek proyek blockchain ya..." />
                  <ol className="list-decimal list-outside text-lg px-4 text-lg leading-relaxed text-slate-800">
                    ...
                    <li className="px-3">
                      <Paragraf Kalimat="Pastikan urutan TVL dari tertinggi ke terendah" />
                    </li>
                    <li className="px-3">
                      <Paragraf Kalimat="Cek kolom paling kanan (MCap/TVL), itulah rasio MC terhadap TVL" />
                    </li>
                    <li className="px-3">
                      <Paragraf Kalimat="Supaya lebih fair, mungkin bs dikelompokkan sendiri...misal dari 10 besar terlebih dahulu" />
                    </li>
                    <li className="px-3">
                      <Paragraf Kalimat="Dari 10 besar TVL, mana yg dibawah 1 atau dibawah 2 misalnya." />
                    </li>
                    <li className="px-3">
                      <Paragraf Kalimat="Maka kita dapatkan calon proyek pilihan, kalo per hari ini (3/10/2021) yaitu : Waves, Fantom, Terra dan Polygon (untuk MC/TVL dibawah 2 diantara Top 10 TVL)" />
                    </li>
                    <li className="px-3">
                      <Paragraf Kalimat="Selanjutnya tetep perlu diriset sendiri calon proyek tsb, cek whitepaper/doc, bagaimana proyeknya, timnya, komunitasnya, use casenya, dan tokenomicnya." />
                    </li>
                  </ol>
                  <Paragraf Kalimat="Dengan cara yang sama bisa kita filter untuk protokol lain, silahkan diulik di defillama. Bisa juga difilter Top 20, Top 100...dst. Misal untuk Dexes yang masih rendah MC/TVL nya untuk Top 10 TVL yaitu Saber, Curve, Balancer...dst" />
                  <Paragraf Kalimat="Kelemahan untuk metode ini adalah jika proyek-proyek blockchain tsb bukan koin smartcontract, semisal BTC atau belum masuk DeFi dan masih bertumbuh, padahal ada potensi juga secara jangka panjang untuk di Hold. Misal Cardano, Polkadot, dll" />
                  <Paragraf Kalimat="Not Financial Advice, Always DYOR" />
                </div>
              </div>
            </div>
          </div>
